...
<section class='politique_banner'>
    <h2> Politique de confidentialité </h2>
</section>

<section class='politique_text container'>
    <h3> Politique de confidentialité </h3>
    <p> Le site web Créaoow est détenu par Créaoow, qui est un contrôleur de données de vos données personnelles.</p>
    <p>Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par Créaoow, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de Créaoow.</p>
    ...
    <p>Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à creaoow.contact@gmail.com.</p>
</section>
